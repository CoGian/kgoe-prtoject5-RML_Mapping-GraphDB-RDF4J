...
public class RMLImdb {
	...
	public static void main(String[] args) throws IOException {
		...
		RMLImdb pipeline = new RMLImdb();

		String rootFolder = "./src/main/resources/rml/";
		String templateFile = "imdb/imdb.mappings.ttl";
		String outputFile = "imdb/outputFile.ttl";
		...
		try {
			connection.add(RMLImdb.class.getResourceAsStream("/rml/imdb/imdb.owl"),
					"urn:base",
					RDFFormat.TURTLE);
			connection.add(GraphDBExample.class.getResourceAsStream("/rml/imdb/outputFile.ttl"),
					"urn:base",
					RDFFormat.TURTLE);
		} catch (IOException e) {
			e.printStackTrace();
